...
$repo = "forge-ops-deploy-meter"
$language = "JavaScript"
$category = "Automation"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/forge-ops-deploy-walkthrough.md")) {
