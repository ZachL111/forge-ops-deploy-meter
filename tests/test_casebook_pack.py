"""Regression checks for the forge-ops-deploy-meter casebook."""
...
from casebook.harness import assert_expected, forge_ops_deploy_meter_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(forge_ops_deploy_meter_summary(), assert_expected())
